...
const AdminGifts = () => {
  ...
  const fetchGifts = () =>{
    axios.get("https://https://8080-afdebdcbccecffabbebafcdcbccfcecaabcfba.project.examly.io/swagger/index.html/admin/getGift").then(response=>{
  ...
  const addGift = (newGift) =>{
    ...
    console.log(gift)
    console.log("added")
    axios.post(`https://https://8080-afdebdcbccecffabbebafcdcbccfcecaabcfba.project.examly.io/swagger/index.html/admin/addGift`,{
      "giftImageUrl" : newGift.giftImageUrl,
      "giftName" : newGift.giftName,
      "giftPrice" : newGift.giftPrice,
      "giftQuantity" : newGift.giftQuantity,
  ...
  const deletedGift = (id, afterGifts) =>{
    ...
    console.log(gifts)
    console.log("deleted")
    axios.delete(`https://https://8080-afdebdcbccecffabbebafcdcbccfcecaabcfba.project.examly.io/swagger/index.html/admin/deleteGift/${id}`)
    .then(response=>{
      setGifts(afterGifts)
    })
  ...
  const updateHandler =(gift) =>{
    axios.put(`https://https://8080-afdebdcbccecffabbebafcdcbccfcecaabcfba.project.examly.io/swagger/index.html/admin/editGift/${gift.id}`, {
      "GiftName": gift.name,
