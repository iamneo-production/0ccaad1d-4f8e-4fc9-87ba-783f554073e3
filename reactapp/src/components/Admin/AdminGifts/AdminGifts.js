...
const AdminGifts = () => {
  ...
  const fetchGifts = () =>{
    axios.get("https://8080-adfacebdabebafcdcbccefeddcbcbaffb.project.examly.io/admin/getGift").then(response=>{
  ...
  const addGift = (newGift) =>{
    ...
    console.log(gift)
    console.log("added")
    axios.post(`https://8080-adfacebdabebafcdcbccefeddcbcbaffb.project.examly.io/admin/addGift`,{
      "giftImageUrl" : newGift.giftImageUrl,
      "giftName" : newGift.giftName,
      "giftPrice" : newGift.giftPrice,
      "giftQuantity" : newGift.giftQuantity,
  ...
  const deletedGift = (id, afterGifts) =>{
    ...
    console.log(gifts)
    console.log("deleted")
    axios.delete(`https://8080-adfacebdabebafcdcbccefeddcbcbaffb.project.examly.io/admin/deleteGift/${id}`)
    .then(response=>{
      setGifts(afterGifts)
    })
  ...
  const updateHandler =(gift) =>{
    axios.put(`https://8080-adfacebdabebafcdcbccefeddcbcbaffb.project.examly.io/admin/editGift/${gift.id}`, {
      "GiftName": gift.name,
