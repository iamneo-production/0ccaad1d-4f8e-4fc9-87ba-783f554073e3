...
const AdminThemes = () => {
 ...
 const themeDelete= async (id) =>{
  await axios.get(`https://8080-adaeccbcebebafcdcbccefeddcbcbaffb.project.examly.io/admin/checkTheme/${id}`)
.then(response=>{
  ...
  axios.delete(`https://8080-adaeccbcebebafcdcbccefeddcbcbaffb.project.examly.io/deleteTheme/${id}`,{
    "themeId": id
  }).then(response=>{
    console.log(response);
  })
...
const updateCompleted = (theme,bool) =>{
  ...
  axios.put(`https://8080-adaeccbcebebafcdcbccefeddcbcbaffb.project.examly.io/editTheme/${theme.themeId}`,
  {
    ...
    axios.get("https://8080-adaeccbcebebafcdcbccefeddcbcbaffb.project.examly.io/admin/getTheme")
    .then(response=>{
...
setAddOrUpdate(bool)
 ...
 const themeAdd = (name, price, description) =>{
        ...
        axios.post("https://8080-adaeccbcebebafcdcbccefeddcbcbaffb.project.examly.io/admin/addTheme",{
          "ThemeName" : name,
          "ThemePrice" : price,
          "ThemeDetails" : description
        })
