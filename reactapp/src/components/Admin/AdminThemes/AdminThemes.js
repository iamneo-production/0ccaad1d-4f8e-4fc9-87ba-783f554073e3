...
const AdminThemes = () => {
 ...
 const themeDelete= async (id) =>{
  await axios.get(`https://https://8080-afdebdcbccecffabbebafcdcbccfcecaabcfba.project.examly.io/swagger/index.html/admin/checkTheme/${id}`)
.then(response=>{
  ...
  axios.delete(`https://https://8080-afdebdcbccecffabbebafcdcbccfcecaabcfba.project.examly.io/swagger/index.html/deleteTheme/${id}`,{
    "themeId": id
  }).then(response=>{
    console.log(response);
  })
...
const updateCompleted = (theme,bool) =>{
  ...
  axios.put(`https://https://8080-afdebdcbccecffabbebafcdcbccfcecaabcfba.project.examly.io/swagger/index.html/editTheme/${theme.themeId}`,
  {
    ...
    axios.get("https://https://8080-afdebdcbccecffabbebafcdcbccfcecaabcfba.project.examly.io/swagger/index.html/admin/getTheme")
    .then(response=>{
...
setAddOrUpdate(bool)
 ...
 const themeAdd = (name, price, description) =>{
        ...
        axios.post("https://https://8080-afdebdcbccecffabbebafcdcbccfcecaabcfba.project.examly.io/swagger/index.html/admin/addTheme",{
          "ThemeName" : name,
          "ThemePrice" : price,
          "ThemeDetails" : description
        })
