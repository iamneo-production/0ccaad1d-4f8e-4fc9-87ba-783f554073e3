...
const Home= () => {
  ...
  const fetchThemes = async() =>{
    const response = await axios.get("https://8080-afdebdcbccecffabbebafcdcbccefeddcbcbaffb.project.examly.io/user/getAllThemes")
    setThemes(response.data.themes)
    console.log(response)
  }
  const fetchGifts = async() =>{
    const response = await axios.get("https://8080-afdebdcbccecffabbebafcdcbccefeddcbcbaffb.project.examly.io/admin/getGift")
