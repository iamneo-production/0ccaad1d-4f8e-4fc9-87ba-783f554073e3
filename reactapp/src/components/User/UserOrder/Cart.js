...
const handlePay = async() =>{
  ...
  for(const cartItem of cart){
    try{
      await axios.post('https://8080-dcfeffdefefcdbebafcdcbccfcecaabcfba.project.examly.io/user/addOrder',{
        "orderName": cartItem.orderGiftName,
        "orderDescription": cartItem.orderDescription,
        "ThemeId": cartItem.orderThemeId,
        "GiftId": cartItem.orderGiftId,
  ...
  const mail = await axios.post('https://8080-dcfeffdefefcdbebafcdcbccfcecaabcfba.project.examly.io/user/orderConfirmation',{
