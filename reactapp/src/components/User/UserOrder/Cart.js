...
const handlePay = async() =>{
  ...
  for(const cartItem of cart){
    try{
      await axios.post('https://https://8080-afdebdcbccecffabbebafcdcbccfcecaabcfba.project.examly.io/swagger/index.html/user/addOrder',{
        "orderName": cartItem.orderGiftName,
        "orderDescription": cartItem.orderDescription,
        "ThemeId": cartItem.orderThemeId,
        "GiftId": cartItem.orderGiftId,
  ...
  const mail = await axios.post('https://https://8080-afdebdcbccecffabbebafcdcbccfcecaabcfba.project.examly.io/swagger/index.html/user/orderConfirmation',{
