...
const Myorder = () => {
  ...
  const fetchOrders = (mail) => {
    axios
      .get(`https://8080-dcfeffdefefcdbebafcdcbccefeddcbcbaffb.project.examly.io/user/Myorders/${mail}`)
  ...
  const handleDelete = (id) => {
    ...
    setCart(updatedData);
    axios
      .delete(`https://8080-dcfeffdefefcdbebafcdcbccefeddcbcbaffb.project.examly.io/user/deleteOrder/${id}`)
      .then((response) => {
